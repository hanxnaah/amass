...
# Use this if you installed Firefox through brew cask
# Selenium::WebDriver::Firefox::Binary.path = '/opt/homebrew-cask/Caskroom/'
#   'firefox/40.0.3/Firefox.app/Contents/MacOS/firefox'
